...
/**
 * @Route(path="/app/nae-core/config-user-permissions")
 */
class ConfigUserPermissionsController extends ConfigBaseController
{
    protected function getLocalStorageFile()
    {
        $file = $this->getLocalStorage() . '/user-permissions.json';
        if (!file_exists($file)) {
