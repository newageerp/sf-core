...
/**
 * @Route(path="/app/nae-core/config-custom-routes")
 */
class ConfigCustomRoutesController extends ConfigBaseController
{
    protected function getLocalStorageFile(): string
    {
        $file = $this->getLocalStorage() . '/custom-routes.json';
        if (!file_exists($file)) {
